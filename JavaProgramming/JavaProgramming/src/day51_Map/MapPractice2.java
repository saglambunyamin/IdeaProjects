...
public class MapPractice2 {
    public static void main(String[] args) {
        ...
        String nameHasMaxSalary = "";
        int maxSalary = Integer.MIN_VALUE;
        for (Map.Entry<String, Integer> entry : map.entrySet()) {
            if (entry.getValue() > maxSalary) {
                maxSalary = entry.getValue();
                nameHasMaxSalary = entry.getKey();
            }
        }
        ...
        for (Map.Entry<String, Integer> entry : map.entrySet()) {
            if (entry.getValue() < minSalary) {
                ...
                nameHasMinSalary = entry.getKey();
            }
        }

        System.out.println(nameHasMaxSalary + " : " + maxSalary);
        System.out.println( nameHasMinSalary + " : " + minSalary);
